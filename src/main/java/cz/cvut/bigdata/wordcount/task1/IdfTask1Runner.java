...
public class IdfTask1Runner extends Configured implements Tool {
...
//		conf.set("textinputformat.record.delimiter", "\n");
        ...
        // Setup MapReduce.
        job.setMapperClass(IdfWordCountPreprocessingMapper.class);
        job.setReducerClass(IdfWordCountVocabularyReducer.class);

        // Make use of a combiner - in this simple case
        // it is the same as the reducer.
//        job.setCombinerClass(IdfWordCountVocabularyReducer.class);
