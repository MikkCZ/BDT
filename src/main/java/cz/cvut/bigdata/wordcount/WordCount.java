...
public class WordCount extends Configured implements Tool {
	 ...
	 * 
	 * The maximum length of a word that will be processed by the target
	 * reducer. For example, using 3 reducers the word length span processed by
	 * the reducers would be: reducer lengths processed -------
	 * ----------------- 00000 1 -- 14 00001 15 -- 29 00003 30 -- OO
	 */
